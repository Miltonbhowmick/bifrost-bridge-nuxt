    ...
    <div>
        <div class="container">
            <div class="newsletter-box">
                <h2 class="headline">Never Miss a Drop</h2>
                <h3 class="sub-headline">
                    Subscribe our newsletter to get more free NFTs information
                    and resources
                </h3>
                <form>
                    <input
                    ...
                    <div class="col">
                        <nuxt-link to="/" class="company"
                            ><img
                                ...
                                :src="
                                    HOST +
                                    getSettings.settings.company_logo.original
                                        .src
                                "
                                :alt="
                                    getSettings.settings.company_logo.original
                        ...
                        <p v-else class="description">
                            Bifrost is the most versatile and dynamic
                            application on the market which supplies trading
                            analysis tools,market information, fractional and
                            tokenised NFT trading as well as the only fully
